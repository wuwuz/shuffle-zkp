...
func SplitAndShareWithProof(secretVal uint64, publicRFr fr_bn254.Element, ccs *frontend.CompiledConstraintSystem, pk *groth16.ProvingKey) (ClientSubmissionToShuffler, ClientSubmissionToServer) {
